<?php
/**
 * Portal AMCAD - Página de Recursos
...
// Obtener recursos
$recursos = getRecursos(true);

$pageTitle = "Portal AMCAD - " . t('recursos', $lang);
?>
<!DOCTYPE html>
...
<body>
            ...
            <div class="header-content">
                ...
                <nav class="main-nav" id="mainNav">
                    <ul>
                        ...
                        <li class="active"><a href="recursos.php"><?php echo t('recursos', $lang); ?></a></li>
    ...
    <section class="content-section">
        <div class="container">
            <h1 class="page-title"><?php echo t('recursos', $lang); ?></h1>
            ...
            <?php if (empty($recursos)): ?>
                <div class="empty-state">
                    <p><?php echo $lang === 'es' ? 'No hay recursos disponibles en este momento.' : 'No resources available at this time.'; ?></p>
                </div>
            <?php endif; ?>
        </div>
    </section>
